<div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
    <div class="file-manager-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            <div class="mb-3">
                <button class="btn btn-success w-100" data-bs-target="#modalRegistrar" data-bs-toggle="modal"><i class="ri-add-line align-bottom"></i> Reporte de ordenes canceladas</button>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle position-relative table-nowrap">
                        ...
                        <tbody id="task-list">
                            ...
                            @if ($jsonData->isEmpty())
                                <tr>
                                    <td colspan="12" class="text-center">No hay productos cancelados</td>
                                </tr>
                            @else
                                    ...
                                    @if ($product->estado == 0)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="badge bg-warning text-uppercase">Error de estado</span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="hstack gap-3 fs-15">
                                                    ...
                                                    <form action="{{ route('jsonData.updateStatus', ['id' => $data->id, 'status' => 1]) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('PATCH')
