<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-bs-theme="light" data-layout-width="fluid" data-layout-position="fixed" data-layout-style="default"><head>
        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="{{ route('login') }}" class="btn btn-link fw-medium text-decoration-none text-body">Iniciar sesión</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-center mt-5">
                            ...
                            <!-- Swiper -->
                            <div class="swiper trusted-client-slider mt-sm-5 mt-4 mb-sm-5 mb-4 swiper-initialized swiper-horizontal swiper-backface-hidden" dir="ltr">
                                <div class="swiper-wrapper" id="swiper-wrapper-c62e2e74b51096488" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-573px, 0px, 0px);">
                                ...
                                <div class="swiper-slide" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="1 / 6" data-swiper-slide-index="0">
                                        <div class="client-images">
                                            <img src="assets/images/clients/amazon.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-prev" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                                        <div class="client-images">
                                            <img src="assets/images/clients/walmart.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-active" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                                        <div class="client-images">
                                            <img src="assets/images/clients/lenovo.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div><div class="swiper-slide swiper-slide-next" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                                        <div class="client-images">
                                            <img src="assets/images/clients/paypal.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div><div class="swiper-slide" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                                        <div class="client-images">
                                            <img src="assets/images/clients/shopify.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div><div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 256.5px; margin-right: 30px;" data-swiper-slide-index="5">
                                        <div class="client-images">
                        ...
                        <div class="card plan-box mb-0">
                            <div class="card-body p-4 m-2">
                                ...
                                <div class="py-4 text-center">
                                    <h1 class="month" style="display: block;"><sup><small>$</small></sup><span class="ff-secondary fw-bold">19</span> <span class="fs-13 text-muted">/Month</span></h1>
                                    <h1 class="annual" style="display: none;"><sup><small>$</small></sup><span class="ff-secondary fw-bold">171</span> <span class="fs-13 text-muted">/Year</span></h1>
                                </div>
                        ...
                        <div class="card plan-box mb-0 ribbon-box right">
                            <div class="card-body p-4 m-2">
                                ...
                                <div class="py-4 text-center">
                                    ...
                                    <h1 class="annual" style="display: none;"><sup><small>$</small></sup><span class="ff-secondary fw-bold">261</span> <span class="fs-13 text-muted">/Year</span></h1>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card plan-box mb-0">
                            <div class="card-body p-4 m-2">
                                ...
                                <div class="py-4 text-center">
                                    <h1 class="month" style="display: block;"><sup><small>$</small></sup><span class="ff-secondary fw-bold">39</span> <span class="fs-13 text-muted">/Month</span></h1>
                                    <h1 class="annual" style="display: none;"><sup><small>$</small></sup><span class="ff-secondary fw-bold">351</span> <span class="fs-13 text-muted">/Year</span></h1>
                                </div>
                        ...
                        <div class="accordion custom-accordionwithicon custom-accordion-border accordion-border-box" id="genques-accordion">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="genques-headingTwo">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#genques-collapseTwo" aria-expanded="true" aria-controls="genques-collapseTwo">
                                        Can a theme have more than one theme?
                                    </button>
                                </h2>
                                <div id="genques-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="genques-headingTwo" data-bs-parent="#genques-accordion" style="">
                                    <div class="accordion-body ff-secondary">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="text-center">
                            ...
                            <!-- Swiper -->
                            <div class="swiper client-review-swiper rounded swiper-initialized swiper-horizontal swiper-backface-hidden" dir="ltr">
                                <div class="swiper-wrapper" id="swiper-wrapper-b3dbd798274b783d" aria-live="off" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiper-slide swiper-slide-active" style="width: 926px;" role="group" aria-label="1 / 3">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                    ...
                                    <!-- end slide -->
                                    <div class="swiper-slide swiper-slide-next" style="width: 926px;" role="group" aria-label="2 / 3">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                    ...
                                    <!-- end slide -->
                                    <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 926px;">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                ...
                                <div class="swiper-button-next bg-white rounded-circle" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-b3dbd798274b783d" aria-disabled="false"></div>
                                <div class="swiper-button-prev bg-white rounded-circle swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-b3dbd798274b783d" aria-disabled="true"></div>
                                <div class="swiper-pagination position-relative mt-2 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
                            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                            <!-- end slider -->
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row text-center gy-4">
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><span class="counter-value" data-target="100">100</span>+</h2>
                    ...
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><span class="counter-value" data-target="24">24</span></h2>
                    ...
                    <div class="col-lg-3 col-6">
                        <div>
                            <h2 class="mb-2"><span class="counter-value" data-target="20.3">20.3</span>k</h2>
